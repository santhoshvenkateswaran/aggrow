...
export class HomeComponent implements OnInit {
  ...
  // cropList = [
  //   "Urad","Turmeric","Tapioca","Sweet potato","Sunflower","Sugarcane","Sesamum","Rice","Ragi","Onion","Moong(Green Gram)","Maize","Jowar",
  //   "Horse-gram","Groundnut","Gram", "Cotton","Coriander","Coconut","Chillies","Castor","Cashewnut","Banana","Bajra","Arecanut",
  // ];
  ...
  ngOnInit(): void {
    ...
    this.isFetched = true;
    this.http
    .get('http://127.0.0.1:5000/api/train')
    .subscribe(data => {
      console.log(data);
  ...
  onPredict(): void {
    if (this.validateInput()) {
      this.http
      .post('http://127.0.0.1:5000/api/predict-crop',{rainfall: this.rainfall, temperature: this.temperature, pH: this.ph})
      .subscribe(data => {
